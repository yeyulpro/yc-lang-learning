      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative rounded-3xl border border-white/10 bg-slate-900/80 p-8 shadow-2xl shadow-cyan-500/10 backdrop-blur-2xl dark:bg-slate-950/90 md:p-12">
          <div className="mb-8 text-center">
            <h1 className="mb-2 text-3xl font-bold text-white md:text-4xl">Create Account</h1>
            <p className="text-sm text-slate-400">Join our English learning community</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="group">
              ...
              {errors.fullName && <p className="mt-1 text-xs text-red-400/80">{errors.fullName}</p>}
            </div>
            ...
            <div className="group">
              ...
              {errors.email && <p className="mt-1 text-xs text-red-400/80">{errors.email}</p>}
            </div>
            ...
            <div className="group">
              ...
              {errors.password && <p className="mt-1 text-xs text-red-400/80">{errors.password}</p>}
              {formData.password && (
            ...
            <div className="group">
              ...
              {errors.confirmPassword && (
                <p className="mt-1 text-xs text-red-400/80">{errors.confirmPassword}</p>
              )}
            ...
            <button type="submit" disabled={isLoading} className={`${primaryBtn} mt-6`}>
              {isLoading ? (
